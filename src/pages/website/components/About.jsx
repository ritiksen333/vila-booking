...
const About = () => {
  return (
    <section className="py-24 overflow-hidden bg-background" id="gallery">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-landing-primary font-semibold uppercase tracking-[0.2em] text-xs">Visual Journey</span>
          <h2 className="text-4xl md:text-5xl font-display mt-4 text-text-primary">Gallery</h2>
        </div>
