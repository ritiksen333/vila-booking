  ...
  return (
    <section className="relative min-h-[100vh] flex items-center pt-24 lg:pt-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center">
        ...
        >
          <p className="text-landing-primary uppercase tracking-[0.3em] text-sm font-semibold mb-4">Welcome To Paradise</p>
          ...
          <p className="text-base md:text-xl text-gray-200 mb-10 max-w-2xl leading-relaxed font-light mx-auto">
            Discover a world of unparalleled luxury and serenity. Our exclusive villas offer breathtaking views, premium amenities, and a truly unforgettable getaway.
          </p>
